...
import com.example.mappingtask.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Hyderabad = new LatLng(17.425168, 78.486153);
        mMap.addMarker(new MarkerOptions().position(Hyderabad).snippet("Hyderabad").title("Marker in Hyderabad").draggable(false));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Hyderabad));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Hyderabad,1f));
    }
}